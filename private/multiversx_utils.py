...
def get_nft_price(stealth_driver, identifier, sleep_time=2):
    currency_path = '/html/body/div[4]/div[2]/div/div/div[2]/div[2]/div[2]/section/div[1]/div/div[2]/div/img'
    amount_path = '/html/body/div[4]/div[2]/div/div/div[2]/div[2]/div[2]/section/div[1]/div/div[2]/div/span/span'
    try:
        url = f'https://xoxno.com/nft/{identifier}'
        stealth_driver.get(url)
        time.sleep(sleep_time)
        currency = stealth_driver.find_element(By.XPATH, currency_path).get_attribute('src').split('/')[-2].upper()
