...
export default function NotFound() {
    const contents = info.contents.en.pages.page_not_found;
    return (
        <div className='flex items-center justify-center w-full min-h-[70vh] dark:text-gray-400 my-12 px-4'>
            <div className='flex flex-col items-center w-full gap-8'>
                ...
                <p className='text-3xl font-semibold text-center'>{contents.description}</p>
                <p className='text-2xl md:px-12 text-center'>{contents.sub_description}</p>
